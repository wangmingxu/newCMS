...
var DeleteResource = function (_RouterBase) {
    _inherits(DeleteResource, _RouterBase);

    function DeleteResource() {
        _classCallCheck(this, DeleteResource);

        return _possibleConstructorReturn(this, (DeleteResource.__proto__ || Object.getPrototypeOf(DeleteResource)).apply(this, arguments));
    }
    ...
    _createClass(DeleteResource, [{
        ...
        value: function handle() {
            ...
            this.req.models.Resource.get(resourceId, function (err, resource) {
                resource.getPlans().remove(function (err) {
                    resource.remove(function (err) {
                        _this2.result.code = 1;
                        _this2.result.msg = '删除资源位成功';
