...
var UpdateMaterial = function (_RouterBase) {
    _inherits(UpdateMaterial, _RouterBase);

    function UpdateMaterial() {
        _classCallCheck(this, UpdateMaterial);

        return _possibleConstructorReturn(this, (UpdateMaterial.__proto__ || Object.getPrototypeOf(UpdateMaterial)).apply(this, arguments));
    }

    _createClass(UpdateMaterial, [{
        key: "handle",
